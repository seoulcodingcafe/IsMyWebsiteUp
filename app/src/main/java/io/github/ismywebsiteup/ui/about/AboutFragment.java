...
package io.github.ismywebsiteup.ui.about;
...
import io.github.ismywebsiteup.WelcomeActivity;
import io.github.ismywebsiteup.ui.About;
...
public class AboutFragment extends PreferenceFragmentCompat {
	...
	public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
		...
		findPreference("commandpermission").setOnPreferenceClickListener(preference -> {
			new About(getActivity()).permission(getView());
			return false;
		});
		findPreference("commandguide").setOnPreferenceClickListener(preference -> {
